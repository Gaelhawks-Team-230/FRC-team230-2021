...
#define TIME_TURNING_TO_ENDZONE_REDA    (2.5*N1SEC)
#define DISTANCE_TO_ENDZONE_REDA        (120)

//Red B
#define TIME_TURNING_TO_B7_REDB         (2*N1SEC)
#define TIME_TURNING_TO_ENDZONE_REDB    (0.5*N1SEC)
#define DISTANCE_TO_ENDZONE_REDB        (200)
