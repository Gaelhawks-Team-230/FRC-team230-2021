...
#define ROTATE_CONSTANT                 (0.2) //used when gyro off
#define COMMAND_RATE_MAX                (150.0)//Radians/sec 

#define MIN_AUTO_ACCELERATION           (-3.0*LOOPTIME)
#define MAX_AUTO_ACCELERATION           (3.0*LOOPTIME)

#define DRIVE_OMEGA                     (5.0)//(4.0)
...
class Drivetrain
{
    ...
    public:
        ...
        void StopAll(void);
        void DriveControl(double, double, bool);
